...
*See also the [corresponding transcript](../transcripts/OFjlPa7Uqeo_comparing-remote-setup-ours-versus-fork-of-ours.md).*
...
- [Corresponding transcript](../transcripts/OFjlPa7Uqeo_comparing-remote-setup-ours-versus-fork-of-ours.md) — verbatim transcript for this video (`video_id` pair)
