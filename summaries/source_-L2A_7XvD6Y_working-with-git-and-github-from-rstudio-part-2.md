...
*See also the [corresponding transcript](../transcripts/-L2A_7XvD6Y_working-with-git-and-github-from-rstudio-part-2.md).*
...
- [Corresponding transcript](../transcripts/-L2A_7XvD6Y_working-with-git-and-github-from-rstudio-part-2.md) — verbatim transcript for this video (`video_id` pair)
