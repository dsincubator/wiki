...
*See also the [corresponding transcript](../transcripts/ciJpIWs3t3k_suggest-commit-changes-directly-on-a-github-pr.md).*
...
- [Corresponding transcript](../transcripts/ciJpIWs3t3k_suggest-commit-changes-directly-on-a-github-pr.md) — verbatim transcript for this video (`video_id` pair)
