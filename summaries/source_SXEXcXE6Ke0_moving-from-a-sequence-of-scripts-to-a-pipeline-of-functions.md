...
*See also the [corresponding transcript](../transcripts/SXEXcXE6Ke0_moving-from-a-sequence-of-scripts-to-a-pipeline-of-functions.md).*
...
- [Corresponding transcript](../transcripts/SXEXcXE6Ke0_moving-from-a-sequence-of-scripts-to-a-pipeline-of-functions.md) — verbatim transcript for this video (`video_id` pair)
