...
*See also the [corresponding transcript](../transcripts/bR0RYYwiDRM_the-simplest-way-to-run-multiple-r-sessions-in-the-same-ide.md).*
...
- [Corresponding transcript](../transcripts/bR0RYYwiDRM_the-simplest-way-to-run-multiple-r-sessions-in-the-same-ide.md) — verbatim transcript for this video (`video_id` pair)
