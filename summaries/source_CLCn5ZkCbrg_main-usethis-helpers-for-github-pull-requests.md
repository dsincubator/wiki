...
*See also the [corresponding transcript](../transcripts/CLCn5ZkCbrg_main-usethis-helpers-for-github-pull-requests.md).*
...
- [Corresponding transcript](../transcripts/CLCn5ZkCbrg_main-usethis-helpers-for-github-pull-requests.md) — verbatim transcript for this video (`video_id` pair)
