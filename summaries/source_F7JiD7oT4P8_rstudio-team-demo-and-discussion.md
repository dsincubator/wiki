...
*See also the [corresponding transcript](../transcripts/F7JiD7oT4P8_rstudio-team-demo-and-discussion.md).*
...
- [Corresponding transcript](../transcripts/F7JiD7oT4P8_rstudio-team-demo-and-discussion.md) — verbatim transcript for this video (`video_id` pair)
