...
*See also the [corresponding transcript](../transcripts/kNV8dDGF7Hw_conversaciones-productivas-sobre-codigo-demo.md).*
...
- [Corresponding transcript](../transcripts/kNV8dDGF7Hw_conversaciones-productivas-sobre-codigo-demo.md) — verbatim transcript for this video (`video_id` pair)
