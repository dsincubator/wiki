...
*See also the [corresponding transcript](../transcripts/TEUbVjhooIg_project-oriented-workflow.md).*
...
- [Corresponding transcript](../transcripts/TEUbVjhooIg_project-oriented-workflow.md) — verbatim transcript for this video (`video_id` pair)
