...
*See also the [corresponding transcript](../transcripts/NuXgJtl9QDw_terminal-running-commands-as-administrator.md).*
...
- [Corresponding transcript](../transcripts/NuXgJtl9QDw_terminal-running-commands-as-administrator.md) — verbatim transcript for this video (`video_id` pair)
