...
*See also the [corresponding transcript](../transcripts/DVmvsZk-9F4_terminal-modify-your-file-system.md).*
...
- [Corresponding transcript](../transcripts/DVmvsZk-9F4_terminal-modify-your-file-system.md) — verbatim transcript for this video (`video_id` pair)
