...
*See also the [corresponding transcript](../transcripts/moAei68dxr0_ds-rpy-running-python-code-from-rstudio.md).*
...
- [Corresponding transcript](../transcripts/moAei68dxr0_ds-rpy-running-python-code-from-rstudio.md) — verbatim transcript for this video (`video_id` pair)
