...
*See also the [corresponding transcript](../transcripts/AxpkFkfTF8o_git-status-add-rm-cached-commit-log.md).*
...
- [Corresponding transcript](../transcripts/AxpkFkfTF8o_git-status-add-rm-cached-commit-log.md) — verbatim transcript for this video (`video_id` pair)
