...
*See also the [corresponding transcript](../transcripts/tLvRWRWeQK4_wtf-debugging-r-code.md).*
...
- [Corresponding transcript](../transcripts/tLvRWRWeQK4_wtf-debugging-r-code.md) — verbatim transcript for this video (`video_id` pair)
