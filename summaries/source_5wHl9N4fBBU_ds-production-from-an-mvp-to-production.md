...
*See also the [corresponding transcript](../transcripts/5wHl9N4fBBU_ds-production-from-an-mvp-to-production.md).*
...
- [Corresponding transcript](../transcripts/5wHl9N4fBBU_ds-production-from-an-mvp-to-production.md) — verbatim transcript for this video (`video_id` pair)
