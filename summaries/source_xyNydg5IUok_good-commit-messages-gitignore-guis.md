...
*See also the [corresponding transcript](../transcripts/xyNydg5IUok_good-commit-messages-gitignore-guis.md).*
...
- [Corresponding transcript](../transcripts/xyNydg5IUok_good-commit-messages-gitignore-guis.md) — verbatim transcript for this video (`video_id` pair)
