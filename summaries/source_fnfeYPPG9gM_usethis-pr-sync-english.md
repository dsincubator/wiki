...
*See also the [corresponding transcript](../transcripts/fnfeYPPG9gM_usethis-pr-sync-english.md).*
...
- [Corresponding transcript](../transcripts/fnfeYPPG9gM_usethis-pr-sync-english.md) — verbatim transcript for this video (`video_id` pair)
