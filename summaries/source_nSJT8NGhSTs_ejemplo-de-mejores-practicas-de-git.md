...
*See also the [corresponding transcript](../transcripts/nSJT8NGhSTs_ejemplo-de-mejores-practicas-de-git.md).*
...
- [Corresponding transcript](../transcripts/nSJT8NGhSTs_ejemplo-de-mejores-practicas-de-git.md) — verbatim transcript for this video (`video_id` pair)
