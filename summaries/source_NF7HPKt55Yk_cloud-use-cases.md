...
*See also the [corresponding transcript](../transcripts/NF7HPKt55Yk_cloud-use-cases.md).*
...
- [Corresponding transcript](../transcripts/NF7HPKt55Yk_cloud-use-cases.md) — verbatim transcript for this video (`video_id` pair)
