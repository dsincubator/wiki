...
*See also the [corresponding transcript](../transcripts/zv5_OSb6lRo_github-flow-the-case-of-publishing-an-new-blog-post.md).*
...
- [Corresponding transcript](../transcripts/zv5_OSb6lRo_github-flow-the-case-of-publishing-an-new-blog-post.md) — verbatim transcript for this video (`video_id` pair)
