...
*See also the [corresponding transcript](../transcripts/q17jsQrBPt0_reprex-package-philosophy.md).*
...
- [Corresponding transcript](../transcripts/q17jsQrBPt0_reprex-package-philosophy.md) — verbatim transcript for this video (`video_id` pair)
