...
*See also the [corresponding transcript](../transcripts/yMPV9TPH3GI_testing-basic-structure-and-basic-workflow.md).*
...
- [Corresponding transcript](../transcripts/yMPV9TPH3GI_testing-basic-structure-and-basic-workflow.md) — verbatim transcript for this video (`video_id` pair)
