...
*See also the [corresponding transcript](../transcripts/YlBnarQNRR8_tidy-eda-defensive-workflow.md).*
...
- [Corresponding transcript](../transcripts/YlBnarQNRR8_tidy-eda-defensive-workflow.md) — verbatim transcript for this video (`video_id` pair)
