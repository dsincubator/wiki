...
*See also the [corresponding transcript](../transcripts/uk-I5WrZsAc_shiny-wrap-up-and-demo.md).*
...
- [Corresponding transcript](../transcripts/uk-I5WrZsAc_shiny-wrap-up-and-demo.md) — verbatim transcript for this video (`video_id` pair)
