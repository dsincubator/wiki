...
*See also the [corresponding transcript](../transcripts/qqKhQdejUOM_project-management-on-github.md).*
...
- [Corresponding transcript](../transcripts/qqKhQdejUOM_project-management-on-github.md) — verbatim transcript for this video (`video_id` pair)
