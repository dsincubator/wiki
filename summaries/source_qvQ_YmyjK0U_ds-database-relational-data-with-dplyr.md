...
*See also the [corresponding transcript](../transcripts/qvQ_YmyjK0U_ds-database-relational-data-with-dplyr.md).*
...
- [Corresponding transcript](../transcripts/qvQ_YmyjK0U_ds-database-relational-data-with-dplyr.md) — verbatim transcript for this video (`video_id` pair)
