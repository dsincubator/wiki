...
*See also the [corresponding transcript](../transcripts/2Lcba2K8j6M_terminal-setup-and-navigate.md).*
...
- [Corresponding transcript](../transcripts/2Lcba2K8j6M_terminal-setup-and-navigate.md) — verbatim transcript for this video (`video_id` pair)
