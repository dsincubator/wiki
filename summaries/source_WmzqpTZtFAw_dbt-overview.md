...
*See also the [corresponding transcript](../transcripts/WmzqpTZtFAw_dbt-overview.md).*
...
- [Corresponding transcript](../transcripts/WmzqpTZtFAw_dbt-overview.md) — verbatim transcript for this video (`video_id` pair)
