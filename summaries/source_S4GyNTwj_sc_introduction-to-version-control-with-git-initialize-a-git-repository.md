...
*See also the [corresponding transcript](../transcripts/S4GyNTwj_sc_introduction-to-version-control-with-git-initialize-a-git-repository.md).*
...
- [Corresponding transcript](../transcripts/S4GyNTwj_sc_introduction-to-version-control-with-git-initialize-a-git-repository.md) — verbatim transcript for this video (`video_id` pair)
