...
*See also the [corresponding transcript](../transcripts/UeECMfOFIHk_testing-using-snapshot-tests-to-refactor-safely.md).*
...
- [Corresponding transcript](../transcripts/UeECMfOFIHk_testing-using-snapshot-tests-to-refactor-safely.md) — verbatim transcript for this video (`video_id` pair)
