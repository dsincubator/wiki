...
*See also the [corresponding transcript](../transcripts/PHFOEKXPaxI_avoid-hidden-arguments.md).*
...
- [Corresponding transcript](../transcripts/PHFOEKXPaxI_avoid-hidden-arguments.md) — verbatim transcript for this video (`video_id` pair)
