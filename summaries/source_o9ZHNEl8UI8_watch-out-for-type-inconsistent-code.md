...
*See also the [corresponding transcript](../transcripts/o9ZHNEl8UI8_watch-out-for-type-inconsistent-code.md).*
...
- [Corresponding transcript](../transcripts/o9ZHNEl8UI8_watch-out-for-type-inconsistent-code.md) — verbatim transcript for this video (`video_id` pair)
