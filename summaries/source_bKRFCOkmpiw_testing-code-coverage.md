...
*See also the [corresponding transcript](../transcripts/bKRFCOkmpiw_testing-code-coverage.md).*
...
- [Corresponding transcript](../transcripts/bKRFCOkmpiw_testing-code-coverage.md) — verbatim transcript for this video (`video_id` pair)
