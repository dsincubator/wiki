...
*See also the [corresponding transcript](../transcripts/GDgir1XXOkw_avoid-recomputing-if-you-can-instead-memoise.md).*
...
- [Corresponding transcript](../transcripts/GDgir1XXOkw_avoid-recomputing-if-you-can-instead-memoise.md) — verbatim transcript for this video (`video_id` pair)
