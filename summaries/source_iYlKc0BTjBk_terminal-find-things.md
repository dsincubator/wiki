...
*See also the [corresponding transcript](../transcripts/iYlKc0BTjBk_terminal-find-things.md).*
...
- [Corresponding transcript](../transcripts/iYlKc0BTjBk_terminal-find-things.md) — verbatim transcript for this video (`video_id` pair)
