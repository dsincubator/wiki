...
*See also the [corresponding transcript](../transcripts/k8GykC4ZXW0_tidy-eda-covariation-between-two-categorical-variables-and-between-two-continuous-variables.md).*
...
- [Corresponding transcript](../transcripts/k8GykC4ZXW0_tidy-eda-covariation-between-two-categorical-variables-and-between-two-continuous-variables.md) — verbatim transcript for this video (`video_id` pair)
