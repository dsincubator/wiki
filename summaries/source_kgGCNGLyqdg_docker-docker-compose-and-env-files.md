...
*See also the [corresponding transcript](../transcripts/kgGCNGLyqdg_docker-docker-compose-and-env-files.md).*
...
- [Corresponding transcript](../transcripts/kgGCNGLyqdg_docker-docker-compose-and-env-files.md) — verbatim transcript for this video (`video_id` pair)
