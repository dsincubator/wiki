...
*See also the [corresponding transcript](../transcripts/XG8DetPZP4c_wtf-installing-r-packages-part-1.md).*
...
- [Corresponding transcript](../transcripts/XG8DetPZP4c_wtf-installing-r-packages-part-1.md) — verbatim transcript for this video (`video_id` pair)
