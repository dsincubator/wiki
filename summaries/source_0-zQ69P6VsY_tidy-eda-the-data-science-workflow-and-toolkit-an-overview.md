...
*See also the [corresponding transcript](../transcripts/0-zQ69P6VsY_tidy-eda-the-data-science-workflow-and-toolkit-an-overview.md).*
...
- [Corresponding transcript](../transcripts/0-zQ69P6VsY_tidy-eda-the-data-science-workflow-and-toolkit-an-overview.md) — verbatim transcript for this video (`video_id` pair)
