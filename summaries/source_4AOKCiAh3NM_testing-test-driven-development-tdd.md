...
*See also the [corresponding transcript](../transcripts/4AOKCiAh3NM_testing-test-driven-development-tdd.md).*
...
- [Corresponding transcript](../transcripts/4AOKCiAh3NM_testing-test-driven-development-tdd.md) — verbatim transcript for this video (`video_id` pair)
