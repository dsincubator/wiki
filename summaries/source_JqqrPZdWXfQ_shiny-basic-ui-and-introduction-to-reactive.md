...
*See also the [corresponding transcript](../transcripts/JqqrPZdWXfQ_shiny-basic-ui-and-introduction-to-reactive.md).*
...
- [Corresponding transcript](../transcripts/JqqrPZdWXfQ_shiny-basic-ui-and-introduction-to-reactive.md) — verbatim transcript for this video (`video_id` pair)
