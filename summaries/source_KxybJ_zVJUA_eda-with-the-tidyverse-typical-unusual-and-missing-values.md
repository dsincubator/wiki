...
*See also the [corresponding transcript](../transcripts/KxybJ_zVJUA_eda-with-the-tidyverse-typical-unusual-and-missing-values.md).*
...
- [Corresponding transcript](../transcripts/KxybJ_zVJUA_eda-with-the-tidyverse-typical-unusual-and-missing-values.md) — verbatim transcript for this video (`video_id` pair)
