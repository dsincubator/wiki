...
*See also the [corresponding transcript](../transcripts/mamqEBZpbtw_cloud-move-data-between-a-server-and-github-with-the-gh-cli.md).*
...
- [Corresponding transcript](../transcripts/mamqEBZpbtw_cloud-move-data-between-a-server-and-github-with-the-gh-cli.md) — verbatim transcript for this video (`video_id` pair)
