...
*See also the [corresponding transcript](../transcripts/Hv6DzT6Z2yA_tidy-eda-patterns-and-models.md).*
...
- [Corresponding transcript](../transcripts/Hv6DzT6Z2yA_tidy-eda-patterns-and-models.md) — verbatim transcript for this video (`video_id` pair)
