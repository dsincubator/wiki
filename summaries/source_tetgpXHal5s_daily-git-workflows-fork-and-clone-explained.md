...
*See also the [corresponding transcript](../transcripts/tetgpXHal5s_daily-git-workflows-fork-and-clone-explained.md).*
...
- [Corresponding transcript](../transcripts/tetgpXHal5s_daily-git-workflows-fork-and-clone-explained.md) — verbatim transcript for this video (`video_id` pair)
