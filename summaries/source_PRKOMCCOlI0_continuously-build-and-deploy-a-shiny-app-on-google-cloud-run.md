...
*See also the [corresponding transcript](../transcripts/PRKOMCCOlI0_continuously-build-and-deploy-a-shiny-app-on-google-cloud-run.md).*
...
- [Corresponding transcript](../transcripts/PRKOMCCOlI0_continuously-build-and-deploy-a-shiny-app-on-google-cloud-run.md) — verbatim transcript for this video (`video_id` pair)
