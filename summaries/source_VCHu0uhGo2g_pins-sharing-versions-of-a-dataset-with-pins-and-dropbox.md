...
*See also the [corresponding transcript](../transcripts/VCHu0uhGo2g_pins-sharing-versions-of-a-dataset-with-pins-and-dropbox.md).*
...
- [Corresponding transcript](../transcripts/VCHu0uhGo2g_pins-sharing-versions-of-a-dataset-with-pins-and-dropbox.md) — verbatim transcript for this video (`video_id` pair)
