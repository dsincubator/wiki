...
*See also the [corresponding transcript](../transcripts/iNWBG3x4QVc_how-to-download-a-file-from-google-drive-into-your-r-ide.md).*
...
- [Corresponding transcript](../transcripts/iNWBG3x4QVc_how-to-download-a-file-from-google-drive-into-your-r-ide.md) — verbatim transcript for this video (`video_id` pair)
