...
*See also the [corresponding transcript](../transcripts/Ulz8Vfnr2P4_ds-database-validate-data-quality.md).*
...
- [Corresponding transcript](../transcripts/Ulz8Vfnr2P4_ds-database-validate-data-quality.md) — verbatim transcript for this video (`video_id` pair)
