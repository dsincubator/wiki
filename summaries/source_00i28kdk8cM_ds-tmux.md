...
*See also the [corresponding transcript](../transcripts/00i28kdk8cM_ds-tmux.md).*
...
- [Corresponding transcript](../transcripts/00i28kdk8cM_ds-tmux.md) — verbatim transcript for this video (`video_id` pair)
