...
*See also the [corresponding transcript](../transcripts/co082qNN_Cs_r-packages-testing.md).*
...
- [Corresponding transcript](../transcripts/co082qNN_Cs_r-packages-testing.md) — verbatim transcript for this video (`video_id` pair)
