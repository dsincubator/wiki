...
*See also the [corresponding transcript](../transcripts/XRF9tge--9I_git-diff-sha1-sha2-path-mv-rm-core-editor.md).*
...
- [Corresponding transcript](../transcripts/XRF9tge--9I_git-diff-sha1-sha2-path-mv-rm-core-editor.md) — verbatim transcript for this video (`video_id` pair)
