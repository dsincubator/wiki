...
*See also the [corresponding transcript](../transcripts/7igKU5JVmxM_inspecting-the-history.md).*
...
- [Corresponding transcript](../transcripts/7igKU5JVmxM_inspecting-the-history.md) — verbatim transcript for this video (`video_id` pair)
