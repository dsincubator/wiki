...
*See also the [corresponding transcript](../transcripts/OofNbCXEVgU_gitflow-workflow.md).*
...
- [Corresponding transcript](../transcripts/OofNbCXEVgU_gitflow-workflow.md) — verbatim transcript for this video (`video_id` pair)
