...
*See also the [corresponding transcript](../transcripts/EB6ODnkdG7A_shiny-basic-reactivity.md).*
...
- [Corresponding transcript](../transcripts/EB6ODnkdG7A_shiny-basic-reactivity.md) — verbatim transcript for this video (`video_id` pair)
