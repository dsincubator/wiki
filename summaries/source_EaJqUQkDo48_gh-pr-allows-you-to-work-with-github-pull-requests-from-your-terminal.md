...
*See also the [corresponding transcript](../transcripts/EaJqUQkDo48_gh-pr-allows-you-to-work-with-github-pull-requests-from-your-terminal.md).*
...
- [Corresponding transcript](../transcripts/EaJqUQkDo48_gh-pr-allows-you-to-work-with-github-pull-requests-from-your-terminal.md) — verbatim transcript for this video (`video_id` pair)
