...
*See also the [corresponding transcript](../transcripts/RO-OdWXfpBc_docker-managing-containers.md).*
...
- [Corresponding transcript](../transcripts/RO-OdWXfpBc_docker-managing-containers.md) — verbatim transcript for this video (`video_id` pair)
