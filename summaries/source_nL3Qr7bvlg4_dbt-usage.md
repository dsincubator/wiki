...
*See also the [corresponding transcript](../transcripts/nL3Qr7bvlg4_dbt-usage.md).*
...
- [Corresponding transcript](../transcripts/nL3Qr7bvlg4_dbt-usage.md) — verbatim transcript for this video (`video_id` pair)
