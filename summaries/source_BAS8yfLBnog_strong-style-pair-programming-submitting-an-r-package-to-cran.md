...
*See also the [corresponding transcript](../transcripts/BAS8yfLBnog_strong-style-pair-programming-submitting-an-r-package-to-cran.md).*
...
- [Corresponding transcript](../transcripts/BAS8yfLBnog_strong-style-pair-programming-submitting-an-r-package-to-cran.md) — verbatim transcript for this video (`video_id` pair)
