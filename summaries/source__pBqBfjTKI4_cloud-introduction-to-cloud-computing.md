...
*See also the [corresponding transcript](../transcripts/_pBqBfjTKI4_cloud-introduction-to-cloud-computing.md).*
...
- [Corresponding transcript](../transcripts/_pBqBfjTKI4_cloud-introduction-to-cloud-computing.md) — verbatim transcript for this video (`video_id` pair)
