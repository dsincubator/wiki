...
*See also the [corresponding transcript](../transcripts/pbc6NX1n01Q_targets-introduction.md).*
...
- [Corresponding transcript](../transcripts/pbc6NX1n01Q_targets-introduction.md) — verbatim transcript for this video (`video_id` pair)
