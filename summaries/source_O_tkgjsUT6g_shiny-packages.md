...
*See also the [corresponding transcript](../transcripts/O_tkgjsUT6g_shiny-packages.md).*
...
- [Corresponding transcript](../transcripts/O_tkgjsUT6g_shiny-packages.md) — verbatim transcript for this video (`video_id` pair)
