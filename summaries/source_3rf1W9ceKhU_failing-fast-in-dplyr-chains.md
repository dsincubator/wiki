...
*See also the [corresponding transcript](../transcripts/3rf1W9ceKhU_failing-fast-in-dplyr-chains.md).*
...
- [Corresponding transcript](../transcripts/3rf1W9ceKhU_failing-fast-in-dplyr-chains.md) — verbatim transcript for this video (`video_id` pair)
