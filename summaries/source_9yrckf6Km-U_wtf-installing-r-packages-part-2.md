...
*See also the [corresponding transcript](../transcripts/9yrckf6Km-U_wtf-installing-r-packages-part-2.md).*
...
- [Corresponding transcript](../transcripts/9yrckf6Km-U_wtf-installing-r-packages-part-2.md) — verbatim transcript for this video (`video_id` pair)
