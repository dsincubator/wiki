...
*See also the [corresponding transcript](../transcripts/g1PRMaTFYdk_usethis-pr-sync-live-ds-incubator-meetup.md).*
...
- [Corresponding transcript](../transcripts/g1PRMaTFYdk_usethis-pr-sync-live-ds-incubator-meetup.md) — verbatim transcript for this video (`video_id` pair)
