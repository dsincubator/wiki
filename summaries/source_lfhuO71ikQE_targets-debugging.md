...
*See also the [corresponding transcript](../transcripts/lfhuO71ikQE_targets-debugging.md).*
...
- [Corresponding transcript](../transcripts/lfhuO71ikQE_targets-debugging.md) — verbatim transcript for this video (`video_id` pair)
