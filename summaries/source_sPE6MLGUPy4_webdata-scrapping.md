...
*See also the [corresponding transcript](../transcripts/sPE6MLGUPy4_webdata-scrapping.md).*
...
- [Corresponding transcript](../transcripts/sPE6MLGUPy4_webdata-scrapping.md) — verbatim transcript for this video (`video_id` pair)
