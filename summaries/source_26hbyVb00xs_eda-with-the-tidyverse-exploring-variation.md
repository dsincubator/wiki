...
*See also the [corresponding transcript](../transcripts/26hbyVb00xs_eda-with-the-tidyverse-exploring-variation.md).*
...
- [Corresponding transcript](../transcripts/26hbyVb00xs_eda-with-the-tidyverse-exploring-variation.md) — verbatim transcript for this video (`video_id` pair)
