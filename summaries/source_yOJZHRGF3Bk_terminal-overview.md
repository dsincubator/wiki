...
*See also the [corresponding transcript](../transcripts/yOJZHRGF3Bk_terminal-overview.md).*
...
- [Corresponding transcript](../transcripts/yOJZHRGF3Bk_terminal-overview.md) — verbatim transcript for this video (`video_id` pair)
