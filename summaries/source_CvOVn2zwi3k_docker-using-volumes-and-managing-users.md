...
*See also the [corresponding transcript](../transcripts/CvOVn2zwi3k_docker-using-volumes-and-managing-users.md).*
...
- [Corresponding transcript](../transcripts/CvOVn2zwi3k_docker-using-volumes-and-managing-users.md) — verbatim transcript for this video (`video_id` pair)
