...
*See also the [corresponding transcript](../transcripts/JdFA31-vJUE_cloud-use-case-host-shiny-apps.md).*
...
- [Corresponding transcript](../transcripts/JdFA31-vJUE_cloud-use-case-host-shiny-apps.md) — verbatim transcript for this video (`video_id` pair)
