...
*See also the [corresponding transcript](../transcripts/Q9S7CvXu3KY_remote-setup-fork-of-ours.md).*
...
- [Corresponding transcript](../transcripts/Q9S7CvXu3KY_remote-setup-fork-of-ours.md) — verbatim transcript for this video (`video_id` pair)
