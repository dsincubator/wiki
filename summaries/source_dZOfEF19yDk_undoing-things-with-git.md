...
*See also the [corresponding transcript](../transcripts/dZOfEF19yDk_undoing-things-with-git.md).*
...
- [Corresponding transcript](../transcripts/dZOfEF19yDk_undoing-things-with-git.md) — verbatim transcript for this video (`video_id` pair)
