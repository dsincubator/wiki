...
*See also the [corresponding transcript](../transcripts/-HTH2ylnT7Q_ds-databricks4r-databricks-for-rstudio-users.md).*
...
- [Corresponding transcript](../transcripts/-HTH2ylnT7Q_ds-databricks4r-databricks-for-rstudio-users.md) — verbatim transcript for this video (`video_id` pair)
