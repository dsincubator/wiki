...
*See also the [corresponding transcript](../transcripts/xW05GsfhuiY_wtf-name-and-organize-files.md).*
...
- [Corresponding transcript](../transcripts/xW05GsfhuiY_wtf-name-and-organize-files.md) — verbatim transcript for this video (`video_id` pair)
