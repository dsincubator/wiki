...
*See also the [corresponding transcript](../transcripts/9JcJFber21w_testing-introduction.md).*
...
- [Corresponding transcript](../transcripts/9JcJFber21w_testing-introduction.md) — verbatim transcript for this video (`video_id` pair)
