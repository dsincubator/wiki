...
*See also the [corresponding transcript](../transcripts/xxtpMXvVM3s_refactoring-how-to-prepare-for-dplyr-1-0-0.md).*
...
- [Corresponding transcript](../transcripts/xxtpMXvVM3s_refactoring-how-to-prepare-for-dplyr-1-0-0.md) — verbatim transcript for this video (`video_id` pair)
