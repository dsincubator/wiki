...
*See also the [corresponding transcript](../transcripts/Pi__2Hze4_0_setup-for-r-package-development.md).*
...
- [Corresponding transcript](../transcripts/Pi__2Hze4_0_setup-for-r-package-development.md) — verbatim transcript for this video (`video_id` pair)
