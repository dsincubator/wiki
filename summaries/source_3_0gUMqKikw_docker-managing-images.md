...
*See also the [corresponding transcript](../transcripts/3_0gUMqKikw_docker-managing-images.md).*
...
- [Corresponding transcript](../transcripts/3_0gUMqKikw_docker-managing-images.md) — verbatim transcript for this video (`video_id` pair)
