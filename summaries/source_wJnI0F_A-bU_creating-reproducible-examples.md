...
*See also the [corresponding transcript](../transcripts/wJnI0F_A-bU_creating-reproducible-examples.md).*
...
- [Corresponding transcript](../transcripts/wJnI0F_A-bU_creating-reproducible-examples.md) — verbatim transcript for this video (`video_id` pair)
