...
*See also the [corresponding transcript](../transcripts/p-p_4ZcDIGw_shiny-your-first-shiny-app.md).*
...
- [Corresponding transcript](../transcripts/p-p_4ZcDIGw_shiny-your-first-shiny-app.md) — verbatim transcript for this video (`video_id` pair)
