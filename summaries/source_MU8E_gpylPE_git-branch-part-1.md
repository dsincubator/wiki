...
*See also the [corresponding transcript](../transcripts/MU8E_gpylPE_git-branch-part-1.md).*
...
- [Corresponding transcript](../transcripts/MU8E_gpylPE_git-branch-part-1.md) — verbatim transcript for this video (`video_id` pair)
