...
*See also the [corresponding transcript](../transcripts/kS_0s0eS1Xw_pins.md).*
...
- [Corresponding transcript](../transcripts/kS_0s0eS1Xw_pins.md) — verbatim transcript for this video (`video_id` pair)
