...
*See also the [corresponding transcript](../transcripts/VRG95a4aBW4_cloud-more-ways-to-move-data.md).*
...
- [Corresponding transcript](../transcripts/VRG95a4aBW4_cloud-more-ways-to-move-data.md) — verbatim transcript for this video (`video_id` pair)
