...
*See also the [corresponding transcript](../transcripts/-9QCNwmpTOE_test-driven-development.md).*
...
- [Corresponding transcript](../transcripts/-9QCNwmpTOE_test-driven-development.md) — verbatim transcript for this video (`video_id` pair)
