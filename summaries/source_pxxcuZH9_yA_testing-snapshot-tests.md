...
*See also the [corresponding transcript](../transcripts/pxxcuZH9_yA_testing-snapshot-tests.md).*
...
- [Corresponding transcript](../transcripts/pxxcuZH9_yA_testing-snapshot-tests.md) — verbatim transcript for this video (`video_id` pair)
