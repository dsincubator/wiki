...
*See also the [corresponding transcript](../transcripts/NgEocgBUH_A_shiny-debugging.md).*
...
- [Corresponding transcript](../transcripts/NgEocgBUH_A_shiny-debugging.md) — verbatim transcript for this video (`video_id` pair)
