...
*See also the [corresponding transcript](../transcripts/AUIJif93OJA_a-systematic-debugging-workflow.md).*
...
- [Corresponding transcript](../transcripts/AUIJif93OJA_a-systematic-debugging-workflow.md) — verbatim transcript for this video (`video_id` pair)
