...
*See also the [corresponding transcript](../transcripts/z4RAuGrAm8c_access-permissions-for-a-github-organization.md).*
...
- [Corresponding transcript](../transcripts/z4RAuGrAm8c_access-permissions-for-a-github-organization.md) — verbatim transcript for this video (`video_id` pair)
