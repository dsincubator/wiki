...
*See also the [corresponding transcript](../transcripts/qY5ForDjgGY_docker-getting-started-with-the-rocker-project.md).*
...
- [Corresponding transcript](../transcripts/qY5ForDjgGY_docker-getting-started-with-the-rocker-project.md) — verbatim transcript for this video (`video_id` pair)
