...
*See also the [corresponding transcript](../transcripts/5gmTK8Cb-WE_merge-conflicts.md).*
...
- [Corresponding transcript](../transcripts/5gmTK8Cb-WE_merge-conflicts.md) — verbatim transcript for this video (`video_id` pair)
