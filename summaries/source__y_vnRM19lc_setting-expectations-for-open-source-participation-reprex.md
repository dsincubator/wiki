...
*See also the [corresponding transcript](../transcripts/_y_vnRM19lc_setting-expectations-for-open-source-participation-reprex.md).*
...
- [Corresponding transcript](../transcripts/_y_vnRM19lc_setting-expectations-for-open-source-participation-reprex.md) — verbatim transcript for this video (`video_id` pair)
