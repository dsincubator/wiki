...
*See also the [corresponding transcript](../transcripts/sbp5Q8niTho_set-up-a-custom-user-library-to-install-r-packages.md).*
...
- [Corresponding transcript](../transcripts/sbp5Q8niTho_set-up-a-custom-user-library-to-install-r-packages.md) — verbatim transcript for this video (`video_id` pair)
