...
*See also the [corresponding transcript](../transcripts/C27MVWqWSMs_r-packages-the-whole-game.md).*
...
- [Corresponding transcript](../transcripts/C27MVWqWSMs_r-packages-the-whole-game.md) — verbatim transcript for this video (`video_id` pair)
