...
*See also the [corresponding transcript](../transcripts/UR4vwDkJMhc_pair-programming.md).*
...
- [Corresponding transcript](../transcripts/UR4vwDkJMhc_pair-programming.md) — verbatim transcript for this video (`video_id` pair)
