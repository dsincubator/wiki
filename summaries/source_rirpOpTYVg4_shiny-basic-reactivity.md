...
*See also the [corresponding transcript](../transcripts/rirpOpTYVg4_shiny-basic-reactivity.md).*
...
- [Corresponding transcript](../transcripts/rirpOpTYVg4_shiny-basic-reactivity.md) — verbatim transcript for this video (`video_id` pair)
