...
*See also the [corresponding transcript](../transcripts/QxgEn2fwIOk_dbt-installation.md).*
...
- [Corresponding transcript](../transcripts/QxgEn2fwIOk_dbt-installation.md) — verbatim transcript for this video (`video_id` pair)
