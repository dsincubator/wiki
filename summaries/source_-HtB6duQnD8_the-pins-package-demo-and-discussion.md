...
*See also the [corresponding transcript](../transcripts/-HtB6duQnD8_the-pins-package-demo-and-discussion.md).*
...
- [Corresponding transcript](../transcripts/-HtB6duQnD8_the-pins-package-demo-and-discussion.md) — verbatim transcript for this video (`video_id` pair)
