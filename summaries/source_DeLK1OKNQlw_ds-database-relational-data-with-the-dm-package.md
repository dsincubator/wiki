...
*See also the [corresponding transcript](../transcripts/DeLK1OKNQlw_ds-database-relational-data-with-the-dm-package.md).*
...
- [Corresponding transcript](../transcripts/DeLK1OKNQlw_ds-database-relational-data-with-the-dm-package.md) — verbatim transcript for this video (`video_id` pair)
