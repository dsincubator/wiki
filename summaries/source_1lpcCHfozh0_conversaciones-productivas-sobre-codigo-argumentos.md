...
*See also the [corresponding transcript](../transcripts/1lpcCHfozh0_conversaciones-productivas-sobre-codigo-argumentos.md).*
...
- [Corresponding transcript](../transcripts/1lpcCHfozh0_conversaciones-productivas-sobre-codigo-argumentos.md) — verbatim transcript for this video (`video_id` pair)
