...
*See also the [corresponding transcript](../transcripts/H9lARi3re9I_ds-database-using-a-relational-database-management-system-rdbms.md).*
...
- [Corresponding transcript](../transcripts/H9lARi3re9I_ds-database-using-a-relational-database-management-system-rdbms.md) — verbatim transcript for this video (`video_id` pair)
