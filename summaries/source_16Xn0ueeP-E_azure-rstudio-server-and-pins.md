...
*See also the [corresponding transcript](../transcripts/16Xn0ueeP-E_azure-rstudio-server-and-pins.md).*
...
- [Corresponding transcript](../transcripts/16Xn0ueeP-E_azure-rstudio-server-and-pins.md) — verbatim transcript for this video (`video_id` pair)
