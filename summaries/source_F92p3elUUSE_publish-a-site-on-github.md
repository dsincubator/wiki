...
*See also the [corresponding transcript](../transcripts/F92p3elUUSE_publish-a-site-on-github.md).*
...
- [Corresponding transcript](../transcripts/F92p3elUUSE_publish-a-site-on-github.md) — verbatim transcript for this video (`video_id` pair)
