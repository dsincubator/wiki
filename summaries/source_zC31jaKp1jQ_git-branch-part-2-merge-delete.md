...
*See also the [corresponding transcript](../transcripts/zC31jaKp1jQ_git-branch-part-2-merge-delete.md).*
...
- [Corresponding transcript](../transcripts/zC31jaKp1jQ_git-branch-part-2-merge-delete.md) — verbatim transcript for this video (`video_id` pair)
