...
*See also the [corresponding transcript](../transcripts/C29QThEYbYY_a-b-testing-r2dii-plot.md).*
...
- [Corresponding transcript](../transcripts/C29QThEYbYY_a-b-testing-r2dii-plot.md) — verbatim transcript for this video (`video_id` pair)
