...
*See also the [corresponding transcript](../transcripts/eeUZ8dHsmG8_git-practices-by-example.md).*
...
- [Corresponding transcript](../transcripts/eeUZ8dHsmG8_git-practices-by-example.md) — verbatim transcript for this video (`video_id` pair)
