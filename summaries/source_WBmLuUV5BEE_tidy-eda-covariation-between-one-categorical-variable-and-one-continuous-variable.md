...
*See also the [corresponding transcript](../transcripts/WBmLuUV5BEE_tidy-eda-covariation-between-one-categorical-variable-and-one-continuous-variable.md).*
...
- [Corresponding transcript](../transcripts/WBmLuUV5BEE_tidy-eda-covariation-between-one-categorical-variable-and-one-continuous-variable.md) — verbatim transcript for this video (`video_id` pair)
