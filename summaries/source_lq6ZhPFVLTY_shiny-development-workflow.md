...
*See also the [corresponding transcript](../transcripts/lq6ZhPFVLTY_shiny-development-workflow.md).*
...
- [Corresponding transcript](../transcripts/lq6ZhPFVLTY_shiny-development-workflow.md) — verbatim transcript for this video (`video_id` pair)
