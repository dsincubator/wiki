...
*See also the [corresponding transcript](../transcripts/_Cl4odbiG78_using-drake-to-develop-smart-reproducible-workflows.md).*
...
- [Corresponding transcript](../transcripts/_Cl4odbiG78_using-drake-to-develop-smart-reproducible-workflows.md) — verbatim transcript for this video (`video_id` pair)
