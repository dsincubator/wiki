...
*See also the [corresponding transcript](../transcripts/YDsoKUVsJls_setup-github-r-rstudio-and-git.md).*
...
- [Corresponding transcript](../transcripts/YDsoKUVsJls_setup-github-r-rstudio-and-git.md) — verbatim transcript for this video (`video_id` pair)
