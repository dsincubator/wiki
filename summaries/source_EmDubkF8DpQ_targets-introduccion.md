...
*See also the [corresponding transcript](../transcripts/EmDubkF8DpQ_targets-introduccion.md).*
...
- [Corresponding transcript](../transcripts/EmDubkF8DpQ_targets-introduccion.md) — verbatim transcript for this video (`video_id` pair)
