...
*See also the [corresponding transcript](../transcripts/jAkNwaGRku0_targets-eexternal-files-and-literate-programming.md).*
...
- [Corresponding transcript](../transcripts/jAkNwaGRku0_targets-eexternal-files-and-literate-programming.md) — verbatim transcript for this video (`video_id` pair)
