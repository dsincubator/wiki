...
*See also the [corresponding transcript](../transcripts/hRUvGna0uK0_r-packages-data.md).*
...
- [Corresponding transcript](../transcripts/hRUvGna0uK0_r-packages-data.md) — verbatim transcript for this video (`video_id` pair)
