...
*See also the [corresponding transcript](../transcripts/tbvsaXwtcPU_moving-commits-across-branches-rebasing-and-squashing.md).*
...
- [Corresponding transcript](../transcripts/tbvsaXwtcPU_moving-commits-across-branches-rebasing-and-squashing.md) — verbatim transcript for this video (`video_id` pair)
