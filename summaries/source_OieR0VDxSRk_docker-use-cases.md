...
*See also the [corresponding transcript](../transcripts/OieR0VDxSRk_docker-use-cases.md).*
...
- [Corresponding transcript](../transcripts/OieR0VDxSRk_docker-use-cases.md) — verbatim transcript for this video (`video_id` pair)
