...
*See also the [corresponding transcript](../transcripts/jyBv5ITO718_terminal-create-a-custom-command-as-a-user-in-a-multi-user-system.md).*
...
- [Corresponding transcript](../transcripts/jyBv5ITO718_terminal-create-a-custom-command-as-a-user-in-a-multi-user-system.md) — verbatim transcript for this video (`video_id` pair)
