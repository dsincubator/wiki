...
*See also the [corresponding transcript](../transcripts/VA3qaeTKTYk_tidying-data.md).*
...
- [Corresponding transcript](../transcripts/VA3qaeTKTYk_tidying-data.md) — verbatim transcript for this video (`video_id` pair)
