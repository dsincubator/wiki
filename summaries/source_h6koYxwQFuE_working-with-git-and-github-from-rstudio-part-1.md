...
*See also the [corresponding transcript](../transcripts/h6koYxwQFuE_working-with-git-and-github-from-rstudio-part-1.md).*
...
- [Corresponding transcript](../transcripts/h6koYxwQFuE_working-with-git-and-github-from-rstudio-part-1.md) — verbatim transcript for this video (`video_id` pair)
