...
*See also the [corresponding transcript](../transcripts/jYvJO2lENbY_git-remotes.md).*
...
- [Corresponding transcript](../transcripts/jYvJO2lENbY_git-remotes.md) — verbatim transcript for this video (`video_id` pair)
