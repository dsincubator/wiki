...
*See also the [corresponding transcript](../transcripts/q-hsaxVA1kc_gh-repo-create-and-gh-browse-to-create-and-browse-a-github-repo-from-the-terminal.md).*
...
- [Corresponding transcript](../transcripts/q-hsaxVA1kc_gh-repo-create-and-gh-browse-to-create-and-browse-a-github-repo-from-the-terminal.md) — verbatim transcript for this video (`video_id` pair)
