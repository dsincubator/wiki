...
*See also the [corresponding transcript](../transcripts/AFuVF0oWFMY_creating-an-empty-r-package-up-to-the-best-standards.md).*
...
- [Corresponding transcript](../transcripts/AFuVF0oWFMY_creating-an-empty-r-package-up-to-the-best-standards.md) — verbatim transcript for this video (`video_id` pair)
