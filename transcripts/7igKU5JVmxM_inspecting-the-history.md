...
*See also the [corresponding summary](../summaries/source_7igKU5JVmxM_inspecting-the-history.md).*
...
See the [corresponding summary](../summaries/source_7igKU5JVmxM_inspecting-the-history.md).

## See also

- [Corresponding summary](../summaries/source_7igKU5JVmxM_inspecting-the-history.md) — provisional synthesis for this video (`video_id` pair)
