...
*See also the [corresponding summary](../summaries/source_gGXwszGqZxM_dbt-structure.md).*
...
See the [corresponding summary](../summaries/source_gGXwszGqZxM_dbt-structure.md).

## See also

- [Corresponding summary](../summaries/source_gGXwszGqZxM_dbt-structure.md) — provisional synthesis for this video (`video_id` pair)
