...
*See also the [corresponding summary](../summaries/source_mamqEBZpbtw_cloud-move-data-between-a-server-and-github-with-the-gh-cli.md).*
...
See the [corresponding summary](../summaries/source_mamqEBZpbtw_cloud-move-data-between-a-server-and-github-with-the-gh-cli.md).

## See also

- [Corresponding summary](../summaries/source_mamqEBZpbtw_cloud-move-data-between-a-server-and-github-with-the-gh-cli.md) — provisional synthesis for this video (`video_id` pair)
