...
*See also the [corresponding summary](../summaries/source_ek3b0m1iCdk_wtf-holistic-workflow-part-2.md).*
...
See the [corresponding summary](../summaries/source_ek3b0m1iCdk_wtf-holistic-workflow-part-2.md).

## See also

- [Corresponding summary](../summaries/source_ek3b0m1iCdk_wtf-holistic-workflow-part-2.md) — provisional synthesis for this video (`video_id` pair)
