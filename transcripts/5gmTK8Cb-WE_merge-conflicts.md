...
*See also the [corresponding summary](../summaries/source_5gmTK8Cb-WE_merge-conflicts.md).*
...
See the [corresponding summary](../summaries/source_5gmTK8Cb-WE_merge-conflicts.md).

## See also

- [Corresponding summary](../summaries/source_5gmTK8Cb-WE_merge-conflicts.md) — provisional synthesis for this video (`video_id` pair)
