...
*See also the [corresponding summary](../summaries/source_Hv6DzT6Z2yA_tidy-eda-patterns-and-models.md).*
...
See the [corresponding summary](../summaries/source_Hv6DzT6Z2yA_tidy-eda-patterns-and-models.md).

## See also

- [Corresponding summary](../summaries/source_Hv6DzT6Z2yA_tidy-eda-patterns-and-models.md) — provisional synthesis for this video (`video_id` pair)
