...
*See also the [corresponding summary](../summaries/source_26hbyVb00xs_eda-with-the-tidyverse-exploring-variation.md).*
...
See the [corresponding summary](../summaries/source_26hbyVb00xs_eda-with-the-tidyverse-exploring-variation.md).

## See also

- [Corresponding summary](../summaries/source_26hbyVb00xs_eda-with-the-tidyverse-exploring-variation.md) — provisional synthesis for this video (`video_id` pair)
