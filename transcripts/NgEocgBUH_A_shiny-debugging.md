...
*See also the [corresponding summary](../summaries/source_NgEocgBUH_A_shiny-debugging.md).*
...
See the [corresponding summary](../summaries/source_NgEocgBUH_A_shiny-debugging.md).

## See also

- [Corresponding summary](../summaries/source_NgEocgBUH_A_shiny-debugging.md) — provisional synthesis for this video (`video_id` pair)
