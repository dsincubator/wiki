...
*See also the [corresponding summary](../summaries/source_qvQ_YmyjK0U_ds-database-relational-data-with-dplyr.md).*
...
See the [corresponding summary](../summaries/source_qvQ_YmyjK0U_ds-database-relational-data-with-dplyr.md).

## See also

- [Corresponding summary](../summaries/source_qvQ_YmyjK0U_ds-database-relational-data-with-dplyr.md) — provisional synthesis for this video (`video_id` pair)
