...
*See also the [corresponding summary](../summaries/source_WBmLuUV5BEE_tidy-eda-covariation-between-one-categorical-variable-and-one-continuous-variable.md).*
...
See the [corresponding summary](../summaries/source_WBmLuUV5BEE_tidy-eda-covariation-between-one-categorical-variable-and-one-continuous-variable.md).

## See also

- [Corresponding summary](../summaries/source_WBmLuUV5BEE_tidy-eda-covariation-between-one-categorical-variable-and-one-continuous-variable.md) — provisional synthesis for this video (`video_id` pair)
