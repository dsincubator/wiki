...
*See also the [corresponding summary](../summaries/source_OFjlPa7Uqeo_comparing-remote-setup-ours-versus-fork-of-ours.md).*
...
See the [corresponding summary](../summaries/source_OFjlPa7Uqeo_comparing-remote-setup-ours-versus-fork-of-ours.md).

## See also

- [Corresponding summary](../summaries/source_OFjlPa7Uqeo_comparing-remote-setup-ours-versus-fork-of-ours.md) — provisional synthesis for this video (`video_id` pair)
