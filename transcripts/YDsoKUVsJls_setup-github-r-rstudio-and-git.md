...
*See also the [corresponding summary](../summaries/source_YDsoKUVsJls_setup-github-r-rstudio-and-git.md).*
...
See the [corresponding summary](../summaries/source_YDsoKUVsJls_setup-github-r-rstudio-and-git.md).

## See also

- [Corresponding summary](../summaries/source_YDsoKUVsJls_setup-github-r-rstudio-and-git.md) — provisional synthesis for this video (`video_id` pair)
