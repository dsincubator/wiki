...
*See also the [corresponding summary](../summaries/source_4AOKCiAh3NM_testing-test-driven-development-tdd.md).*
...
See the [corresponding summary](../summaries/source_4AOKCiAh3NM_testing-test-driven-development-tdd.md).

## See also

- [Corresponding summary](../summaries/source_4AOKCiAh3NM_testing-test-driven-development-tdd.md) — provisional synthesis for this video (`video_id` pair)
