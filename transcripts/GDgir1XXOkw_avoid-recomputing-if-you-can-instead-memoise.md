...
*See also the [corresponding summary](../summaries/source_GDgir1XXOkw_avoid-recomputing-if-you-can-instead-memoise.md).*
...
See the [corresponding summary](../summaries/source_GDgir1XXOkw_avoid-recomputing-if-you-can-instead-memoise.md).

## See also

- [Corresponding summary](../summaries/source_GDgir1XXOkw_avoid-recomputing-if-you-can-instead-memoise.md) — provisional synthesis for this video (`video_id` pair)
