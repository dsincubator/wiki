...
*See also the [corresponding summary](../summaries/source_pxxcuZH9_yA_testing-snapshot-tests.md).*
...
See the [corresponding summary](../summaries/source_pxxcuZH9_yA_testing-snapshot-tests.md).

## See also

- [Corresponding summary](../summaries/source_pxxcuZH9_yA_testing-snapshot-tests.md) — provisional synthesis for this video (`video_id` pair)
