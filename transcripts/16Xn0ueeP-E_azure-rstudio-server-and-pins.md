...
*See also the [corresponding summary](../summaries/source_16Xn0ueeP-E_azure-rstudio-server-and-pins.md).*
...
See the [corresponding summary](../summaries/source_16Xn0ueeP-E_azure-rstudio-server-and-pins.md).

## See also

- [Corresponding summary](../summaries/source_16Xn0ueeP-E_azure-rstudio-server-and-pins.md) — provisional synthesis for this video (`video_id` pair)
