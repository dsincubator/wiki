...
*See also the [corresponding summary](../summaries/source_PRKOMCCOlI0_continuously-build-and-deploy-a-shiny-app-on-google-cloud-run.md).*
...
See the [corresponding summary](../summaries/source_PRKOMCCOlI0_continuously-build-and-deploy-a-shiny-app-on-google-cloud-run.md).

## See also

- [Corresponding summary](../summaries/source_PRKOMCCOlI0_continuously-build-and-deploy-a-shiny-app-on-google-cloud-run.md) — provisional synthesis for this video (`video_id` pair)
