...
*See also the [corresponding summary](../summaries/source_MU8E_gpylPE_git-branch-part-1.md).*
...
See the [corresponding summary](../summaries/source_MU8E_gpylPE_git-branch-part-1.md).

## See also

- [Corresponding summary](../summaries/source_MU8E_gpylPE_git-branch-part-1.md) — provisional synthesis for this video (`video_id` pair)
