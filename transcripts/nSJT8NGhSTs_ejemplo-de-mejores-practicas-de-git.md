...
*See also the [corresponding summary](../summaries/source_nSJT8NGhSTs_ejemplo-de-mejores-practicas-de-git.md).*
...
See the [corresponding summary](../summaries/source_nSJT8NGhSTs_ejemplo-de-mejores-practicas-de-git.md).

## See also

- [Corresponding summary](../summaries/source_nSJT8NGhSTs_ejemplo-de-mejores-practicas-de-git.md) — provisional synthesis for this video (`video_id` pair)
