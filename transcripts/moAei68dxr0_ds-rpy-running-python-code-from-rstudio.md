...
*See also the [corresponding summary](../summaries/source_moAei68dxr0_ds-rpy-running-python-code-from-rstudio.md).*
...
See the [corresponding summary](../summaries/source_moAei68dxr0_ds-rpy-running-python-code-from-rstudio.md).

## See also

- [Corresponding summary](../summaries/source_moAei68dxr0_ds-rpy-running-python-code-from-rstudio.md) — provisional synthesis for this video (`video_id` pair)
