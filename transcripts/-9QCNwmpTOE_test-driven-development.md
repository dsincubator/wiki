...
*See also the [corresponding summary](../summaries/source_-9QCNwmpTOE_test-driven-development.md).*
...
See the [corresponding summary](../summaries/source_-9QCNwmpTOE_test-driven-development.md).

## See also

- [Corresponding summary](../summaries/source_-9QCNwmpTOE_test-driven-development.md) — provisional synthesis for this video (`video_id` pair)
