...
*See also the [corresponding summary](../summaries/source_yMPV9TPH3GI_testing-basic-structure-and-basic-workflow.md).*
...
See the [corresponding summary](../summaries/source_yMPV9TPH3GI_testing-basic-structure-and-basic-workflow.md).

## See also

- [Corresponding summary](../summaries/source_yMPV9TPH3GI_testing-basic-structure-and-basic-workflow.md) — provisional synthesis for this video (`video_id` pair)
