...
*See also the [corresponding summary](../summaries/source_C27MVWqWSMs_r-packages-the-whole-game.md).*
...
See the [corresponding summary](../summaries/source_C27MVWqWSMs_r-packages-the-whole-game.md).

## See also

- [Corresponding summary](../summaries/source_C27MVWqWSMs_r-packages-the-whole-game.md) — provisional synthesis for this video (`video_id` pair)
