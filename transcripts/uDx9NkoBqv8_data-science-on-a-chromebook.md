...
*See also the [corresponding summary](../summaries/source_uDx9NkoBqv8_data-science-on-a-chromebook.md).*
...
See the [corresponding summary](../summaries/source_uDx9NkoBqv8_data-science-on-a-chromebook.md).

## See also

- [Corresponding summary](../summaries/source_uDx9NkoBqv8_data-science-on-a-chromebook.md) — provisional synthesis for this video (`video_id` pair)
