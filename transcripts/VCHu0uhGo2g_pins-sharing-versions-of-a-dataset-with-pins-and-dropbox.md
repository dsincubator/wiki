...
*See also the [corresponding summary](../summaries/source_VCHu0uhGo2g_pins-sharing-versions-of-a-dataset-with-pins-and-dropbox.md).*
...
See the [corresponding summary](../summaries/source_VCHu0uhGo2g_pins-sharing-versions-of-a-dataset-with-pins-and-dropbox.md).

## See also

- [Corresponding summary](../summaries/source_VCHu0uhGo2g_pins-sharing-versions-of-a-dataset-with-pins-and-dropbox.md) — provisional synthesis for this video (`video_id` pair)
