...
*See also the [corresponding summary](../summaries/source_k8GykC4ZXW0_tidy-eda-covariation-between-two-categorical-variables-and-between-two-continuous-variables.md).*
...
See the [corresponding summary](../summaries/source_k8GykC4ZXW0_tidy-eda-covariation-between-two-categorical-variables-and-between-two-continuous-variables.md).

## See also

- [Corresponding summary](../summaries/source_k8GykC4ZXW0_tidy-eda-covariation-between-two-categorical-variables-and-between-two-continuous-variables.md) — provisional synthesis for this video (`video_id` pair)
