...
*See also the [corresponding summary](../summaries/source__Cl4odbiG78_using-drake-to-develop-smart-reproducible-workflows.md).*
...
See the [corresponding summary](../summaries/source__Cl4odbiG78_using-drake-to-develop-smart-reproducible-workflows.md).

## See also

- [Corresponding summary](../summaries/source__Cl4odbiG78_using-drake-to-develop-smart-reproducible-workflows.md) — provisional synthesis for this video (`video_id` pair)
