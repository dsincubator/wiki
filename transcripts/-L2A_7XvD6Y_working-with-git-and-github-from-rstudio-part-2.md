...
*See also the [corresponding summary](../summaries/source_-L2A_7XvD6Y_working-with-git-and-github-from-rstudio-part-2.md).*
...
See the [corresponding summary](../summaries/source_-L2A_7XvD6Y_working-with-git-and-github-from-rstudio-part-2.md).

## See also

- [Corresponding summary](../summaries/source_-L2A_7XvD6Y_working-with-git-and-github-from-rstudio-part-2.md) — provisional synthesis for this video (`video_id` pair)
