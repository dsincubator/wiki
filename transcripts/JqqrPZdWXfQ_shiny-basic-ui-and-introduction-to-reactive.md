...
*See also the [corresponding summary](../summaries/source_JqqrPZdWXfQ_shiny-basic-ui-and-introduction-to-reactive.md).*
...
See the [corresponding summary](../summaries/source_JqqrPZdWXfQ_shiny-basic-ui-and-introduction-to-reactive.md).

## See also

- [Corresponding summary](../summaries/source_JqqrPZdWXfQ_shiny-basic-ui-and-introduction-to-reactive.md) — provisional synthesis for this video (`video_id` pair)
