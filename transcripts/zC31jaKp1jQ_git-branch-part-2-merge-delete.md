...
*See also the [corresponding summary](../summaries/source_zC31jaKp1jQ_git-branch-part-2-merge-delete.md).*
...
See the [corresponding summary](../summaries/source_zC31jaKp1jQ_git-branch-part-2-merge-delete.md).

## See also

- [Corresponding summary](../summaries/source_zC31jaKp1jQ_git-branch-part-2-merge-delete.md) — provisional synthesis for this video (`video_id` pair)
