...
*See also the [corresponding summary](../summaries/source_vpAW3j5zbX0_daily-stand-ups.md).*
...
See the [corresponding summary](../summaries/source_vpAW3j5zbX0_daily-stand-ups.md).

## See also

- [Corresponding summary](../summaries/source_vpAW3j5zbX0_daily-stand-ups.md) — provisional synthesis for this video (`video_id` pair)
