...
*See also the [corresponding summary](../summaries/source_jyBv5ITO718_terminal-create-a-custom-command-as-a-user-in-a-multi-user-system.md).*
...
See the [corresponding summary](../summaries/source_jyBv5ITO718_terminal-create-a-custom-command-as-a-user-in-a-multi-user-system.md).

## See also

- [Corresponding summary](../summaries/source_jyBv5ITO718_terminal-create-a-custom-command-as-a-user-in-a-multi-user-system.md) — provisional synthesis for this video (`video_id` pair)
