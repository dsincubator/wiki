...
*See also the [corresponding summary](../summaries/source_EB6ODnkdG7A_shiny-basic-reactivity.md).*
...
See the [corresponding summary](../summaries/source_EB6ODnkdG7A_shiny-basic-reactivity.md).

## See also

- [Corresponding summary](../summaries/source_EB6ODnkdG7A_shiny-basic-reactivity.md) — provisional synthesis for this video (`video_id` pair)
