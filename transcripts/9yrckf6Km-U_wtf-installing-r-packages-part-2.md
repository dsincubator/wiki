...
*See also the [corresponding summary](../summaries/source_9yrckf6Km-U_wtf-installing-r-packages-part-2.md).*
...
See the [corresponding summary](../summaries/source_9yrckf6Km-U_wtf-installing-r-packages-part-2.md).

## See also

- [Corresponding summary](../summaries/source_9yrckf6Km-U_wtf-installing-r-packages-part-2.md) — provisional synthesis for this video (`video_id` pair)
