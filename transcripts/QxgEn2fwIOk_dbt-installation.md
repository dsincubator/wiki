...
*See also the [corresponding summary](../summaries/source_QxgEn2fwIOk_dbt-installation.md).*
...
See the [corresponding summary](../summaries/source_QxgEn2fwIOk_dbt-installation.md).

## See also

- [Corresponding summary](../summaries/source_QxgEn2fwIOk_dbt-installation.md) — provisional synthesis for this video (`video_id` pair)
