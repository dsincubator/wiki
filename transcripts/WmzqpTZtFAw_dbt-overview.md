...
*See also the [corresponding summary](../summaries/source_WmzqpTZtFAw_dbt-overview.md).*
...
See the [corresponding summary](../summaries/source_WmzqpTZtFAw_dbt-overview.md).

## See also

- [Corresponding summary](../summaries/source_WmzqpTZtFAw_dbt-overview.md) — provisional synthesis for this video (`video_id` pair)
