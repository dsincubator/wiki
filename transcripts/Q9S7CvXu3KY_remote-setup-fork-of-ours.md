...
*See also the [corresponding summary](../summaries/source_Q9S7CvXu3KY_remote-setup-fork-of-ours.md).*
...
See the [corresponding summary](../summaries/source_Q9S7CvXu3KY_remote-setup-fork-of-ours.md).

## See also

- [Corresponding summary](../summaries/source_Q9S7CvXu3KY_remote-setup-fork-of-ours.md) — provisional synthesis for this video (`video_id` pair)
