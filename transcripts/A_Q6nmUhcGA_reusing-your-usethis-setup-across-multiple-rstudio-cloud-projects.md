...
*See also the [corresponding summary](../summaries/source_A_Q6nmUhcGA_reusing-your-usethis-setup-across-multiple-rstudio-cloud-projects.md).*
...
See the [corresponding summary](../summaries/source_A_Q6nmUhcGA_reusing-your-usethis-setup-across-multiple-rstudio-cloud-projects.md).

## See also

- [Corresponding summary](../summaries/source_A_Q6nmUhcGA_reusing-your-usethis-setup-across-multiple-rstudio-cloud-projects.md) — provisional synthesis for this video (`video_id` pair)
