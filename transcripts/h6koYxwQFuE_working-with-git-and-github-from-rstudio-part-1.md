...
*See also the [corresponding summary](../summaries/source_h6koYxwQFuE_working-with-git-and-github-from-rstudio-part-1.md).*
...
See the [corresponding summary](../summaries/source_h6koYxwQFuE_working-with-git-and-github-from-rstudio-part-1.md).

## See also

- [Corresponding summary](../summaries/source_h6koYxwQFuE_working-with-git-and-github-from-rstudio-part-1.md) — provisional synthesis for this video (`video_id` pair)
