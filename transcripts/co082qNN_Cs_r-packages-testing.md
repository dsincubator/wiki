...
*See also the [corresponding summary](../summaries/source_co082qNN_Cs_r-packages-testing.md).*
...
See the [corresponding summary](../summaries/source_co082qNN_Cs_r-packages-testing.md).

## See also

- [Corresponding summary](../summaries/source_co082qNN_Cs_r-packages-testing.md) — provisional synthesis for this video (`video_id` pair)
