...
*See also the [corresponding summary](../summaries/source_JdFA31-vJUE_cloud-use-case-host-shiny-apps.md).*
...
See the [corresponding summary](../summaries/source_JdFA31-vJUE_cloud-use-case-host-shiny-apps.md).

## See also

- [Corresponding summary](../summaries/source_JdFA31-vJUE_cloud-use-case-host-shiny-apps.md) — provisional synthesis for this video (`video_id` pair)
