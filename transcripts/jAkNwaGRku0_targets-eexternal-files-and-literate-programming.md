...
*See also the [corresponding summary](../summaries/source_jAkNwaGRku0_targets-eexternal-files-and-literate-programming.md).*
...
See the [corresponding summary](../summaries/source_jAkNwaGRku0_targets-eexternal-files-and-literate-programming.md).

## See also

- [Corresponding summary](../summaries/source_jAkNwaGRku0_targets-eexternal-files-and-literate-programming.md) — provisional synthesis for this video (`video_id` pair)
