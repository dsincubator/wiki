...
*See also the [corresponding summary](../summaries/source_H9lARi3re9I_ds-database-using-a-relational-database-management-system-rdbms.md).*
...
See the [corresponding summary](../summaries/source_H9lARi3re9I_ds-database-using-a-relational-database-management-system-rdbms.md).

## See also

- [Corresponding summary](../summaries/source_H9lARi3re9I_ds-database-using-a-relational-database-management-system-rdbms.md) — provisional synthesis for this video (`video_id` pair)
