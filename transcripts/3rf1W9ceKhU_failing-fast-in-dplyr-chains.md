...
*See also the [corresponding summary](../summaries/source_3rf1W9ceKhU_failing-fast-in-dplyr-chains.md).*
...
See the [corresponding summary](../summaries/source_3rf1W9ceKhU_failing-fast-in-dplyr-chains.md).

## See also

- [Corresponding summary](../summaries/source_3rf1W9ceKhU_failing-fast-in-dplyr-chains.md) — provisional synthesis for this video (`video_id` pair)
