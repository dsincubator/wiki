...
*See also the [corresponding summary](../summaries/source_zv5_OSb6lRo_github-flow-the-case-of-publishing-an-new-blog-post.md).*
...
See the [corresponding summary](../summaries/source_zv5_OSb6lRo_github-flow-the-case-of-publishing-an-new-blog-post.md).

## See also

- [Corresponding summary](../summaries/source_zv5_OSb6lRo_github-flow-the-case-of-publishing-an-new-blog-post.md) — provisional synthesis for this video (`video_id` pair)
