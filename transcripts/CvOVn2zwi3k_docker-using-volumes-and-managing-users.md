...
*See also the [corresponding summary](../summaries/source_CvOVn2zwi3k_docker-using-volumes-and-managing-users.md).*
...
See the [corresponding summary](../summaries/source_CvOVn2zwi3k_docker-using-volumes-and-managing-users.md).

## See also

- [Corresponding summary](../summaries/source_CvOVn2zwi3k_docker-using-volumes-and-managing-users.md) — provisional synthesis for this video (`video_id` pair)
