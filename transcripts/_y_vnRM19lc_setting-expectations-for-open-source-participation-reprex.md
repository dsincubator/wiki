...
*See also the [corresponding summary](../summaries/source__y_vnRM19lc_setting-expectations-for-open-source-participation-reprex.md).*
...
See the [corresponding summary](../summaries/source__y_vnRM19lc_setting-expectations-for-open-source-participation-reprex.md).

## See also

- [Corresponding summary](../summaries/source__y_vnRM19lc_setting-expectations-for-open-source-participation-reprex.md) — provisional synthesis for this video (`video_id` pair)
