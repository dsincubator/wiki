...
*See also the [corresponding summary](../summaries/source_BAS8yfLBnog_strong-style-pair-programming-submitting-an-r-package-to-cran.md).*
...
See the [corresponding summary](../summaries/source_BAS8yfLBnog_strong-style-pair-programming-submitting-an-r-package-to-cran.md).

## See also

- [Corresponding summary](../summaries/source_BAS8yfLBnog_strong-style-pair-programming-submitting-an-r-package-to-cran.md) — provisional synthesis for this video (`video_id` pair)
