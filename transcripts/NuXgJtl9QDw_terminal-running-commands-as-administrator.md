...
*See also the [corresponding summary](../summaries/source_NuXgJtl9QDw_terminal-running-commands-as-administrator.md).*
...
See the [corresponding summary](../summaries/source_NuXgJtl9QDw_terminal-running-commands-as-administrator.md).

## See also

- [Corresponding summary](../summaries/source_NuXgJtl9QDw_terminal-running-commands-as-administrator.md) — provisional synthesis for this video (`video_id` pair)
