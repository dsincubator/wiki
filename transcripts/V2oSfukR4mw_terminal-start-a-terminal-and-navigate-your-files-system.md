...
*See also the [corresponding summary](../summaries/source_V2oSfukR4mw_terminal-start-a-terminal-and-navigate-your-files-system.md).*
...
See the [corresponding summary](../summaries/source_V2oSfukR4mw_terminal-start-a-terminal-and-navigate-your-files-system.md).

## See also

- [Corresponding summary](../summaries/source_V2oSfukR4mw_terminal-start-a-terminal-and-navigate-your-files-system.md) — provisional synthesis for this video (`video_id` pair)
