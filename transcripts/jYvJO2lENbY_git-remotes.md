...
*See also the [corresponding summary](../summaries/source_jYvJO2lENbY_git-remotes.md).*
...
See the [corresponding summary](../summaries/source_jYvJO2lENbY_git-remotes.md).

## See also

- [Corresponding summary](../summaries/source_jYvJO2lENbY_git-remotes.md) — provisional synthesis for this video (`video_id` pair)
