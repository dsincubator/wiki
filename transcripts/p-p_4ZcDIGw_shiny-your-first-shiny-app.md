...
*See also the [corresponding summary](../summaries/source_p-p_4ZcDIGw_shiny-your-first-shiny-app.md).*
...
See the [corresponding summary](../summaries/source_p-p_4ZcDIGw_shiny-your-first-shiny-app.md).

## See also

- [Corresponding summary](../summaries/source_p-p_4ZcDIGw_shiny-your-first-shiny-app.md) — provisional synthesis for this video (`video_id` pair)
