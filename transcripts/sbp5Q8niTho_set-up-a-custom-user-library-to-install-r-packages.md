...
*See also the [corresponding summary](../summaries/source_sbp5Q8niTho_set-up-a-custom-user-library-to-install-r-packages.md).*
...
See the [corresponding summary](../summaries/source_sbp5Q8niTho_set-up-a-custom-user-library-to-install-r-packages.md).

## See also

- [Corresponding summary](../summaries/source_sbp5Q8niTho_set-up-a-custom-user-library-to-install-r-packages.md) — provisional synthesis for this video (`video_id` pair)
