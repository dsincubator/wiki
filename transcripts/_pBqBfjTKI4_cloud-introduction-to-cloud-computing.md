...
*See also the [corresponding summary](../summaries/source__pBqBfjTKI4_cloud-introduction-to-cloud-computing.md).*
...
See the [corresponding summary](../summaries/source__pBqBfjTKI4_cloud-introduction-to-cloud-computing.md).

## See also

- [Corresponding summary](../summaries/source__pBqBfjTKI4_cloud-introduction-to-cloud-computing.md) — provisional synthesis for this video (`video_id` pair)
