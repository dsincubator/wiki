...
*See also the [corresponding summary](../summaries/source_OieR0VDxSRk_docker-use-cases.md).*
...
See the [corresponding summary](../summaries/source_OieR0VDxSRk_docker-use-cases.md).

## See also

- [Corresponding summary](../summaries/source_OieR0VDxSRk_docker-use-cases.md) — provisional synthesis for this video (`video_id` pair)
