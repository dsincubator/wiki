...
*See also the [corresponding summary](../summaries/source_xxtpMXvVM3s_refactoring-how-to-prepare-for-dplyr-1-0-0.md).*
...
See the [corresponding summary](../summaries/source_xxtpMXvVM3s_refactoring-how-to-prepare-for-dplyr-1-0-0.md).

## See also

- [Corresponding summary](../summaries/source_xxtpMXvVM3s_refactoring-how-to-prepare-for-dplyr-1-0-0.md) — provisional synthesis for this video (`video_id` pair)
