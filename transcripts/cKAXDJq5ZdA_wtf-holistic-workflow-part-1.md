...
*See also the [corresponding summary](../summaries/source_cKAXDJq5ZdA_wtf-holistic-workflow-part-1.md).*
...
See the [corresponding summary](../summaries/source_cKAXDJq5ZdA_wtf-holistic-workflow-part-1.md).

## See also

- [Corresponding summary](../summaries/source_cKAXDJq5ZdA_wtf-holistic-workflow-part-1.md) — provisional synthesis for this video (`video_id` pair)
