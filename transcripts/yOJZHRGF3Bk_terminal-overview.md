...
*See also the [corresponding summary](../summaries/source_yOJZHRGF3Bk_terminal-overview.md).*
...
See the [corresponding summary](../summaries/source_yOJZHRGF3Bk_terminal-overview.md).

## See also

- [Corresponding summary](../summaries/source_yOJZHRGF3Bk_terminal-overview.md) — provisional synthesis for this video (`video_id` pair)
