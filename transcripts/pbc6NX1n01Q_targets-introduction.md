...
*See also the [corresponding summary](../summaries/source_pbc6NX1n01Q_targets-introduction.md).*
...
See the [corresponding summary](../summaries/source_pbc6NX1n01Q_targets-introduction.md).

## See also

- [Corresponding summary](../summaries/source_pbc6NX1n01Q_targets-introduction.md) — provisional synthesis for this video (`video_id` pair)
