...
*See also the [corresponding summary](../summaries/source_nL3Qr7bvlg4_dbt-usage.md).*
...
See the [corresponding summary](../summaries/source_nL3Qr7bvlg4_dbt-usage.md).

## See also

- [Corresponding summary](../summaries/source_nL3Qr7bvlg4_dbt-usage.md) — provisional synthesis for this video (`video_id` pair)
