...
*See also the [corresponding summary](../summaries/source_lq6ZhPFVLTY_shiny-development-workflow.md).*
...
See the [corresponding summary](../summaries/source_lq6ZhPFVLTY_shiny-development-workflow.md).

## See also

- [Corresponding summary](../summaries/source_lq6ZhPFVLTY_shiny-development-workflow.md) — provisional synthesis for this video (`video_id` pair)
