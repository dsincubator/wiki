...
*See also the [corresponding summary](../summaries/source_YlBnarQNRR8_tidy-eda-defensive-workflow.md).*
...
See the [corresponding summary](../summaries/source_YlBnarQNRR8_tidy-eda-defensive-workflow.md).

## See also

- [Corresponding summary](../summaries/source_YlBnarQNRR8_tidy-eda-defensive-workflow.md) — provisional synthesis for this video (`video_id` pair)
