...
*See also the [corresponding summary](../summaries/source_fnfeYPPG9gM_usethis-pr-sync-english.md).*
...
See the [corresponding summary](../summaries/source_fnfeYPPG9gM_usethis-pr-sync-english.md).

## See also

- [Corresponding summary](../summaries/source_fnfeYPPG9gM_usethis-pr-sync-english.md) — provisional synthesis for this video (`video_id` pair)
