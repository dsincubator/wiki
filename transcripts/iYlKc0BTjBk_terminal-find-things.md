...
*See also the [corresponding summary](../summaries/source_iYlKc0BTjBk_terminal-find-things.md).*
...
See the [corresponding summary](../summaries/source_iYlKc0BTjBk_terminal-find-things.md).

## See also

- [Corresponding summary](../summaries/source_iYlKc0BTjBk_terminal-find-things.md) — provisional synthesis for this video (`video_id` pair)
