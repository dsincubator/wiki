...
*See also the [corresponding summary](../summaries/source_DeLK1OKNQlw_ds-database-relational-data-with-the-dm-package.md).*
...
See the [corresponding summary](../summaries/source_DeLK1OKNQlw_ds-database-relational-data-with-the-dm-package.md).

## See also

- [Corresponding summary](../summaries/source_DeLK1OKNQlw_ds-database-relational-data-with-the-dm-package.md) — provisional synthesis for this video (`video_id` pair)
