...
*See also the [corresponding summary](../summaries/source_OofNbCXEVgU_gitflow-workflow.md).*
...
See the [corresponding summary](../summaries/source_OofNbCXEVgU_gitflow-workflow.md).

## See also

- [Corresponding summary](../summaries/source_OofNbCXEVgU_gitflow-workflow.md) — provisional synthesis for this video (`video_id` pair)
