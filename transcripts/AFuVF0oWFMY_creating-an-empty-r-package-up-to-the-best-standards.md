...
*See also the [corresponding summary](../summaries/source_AFuVF0oWFMY_creating-an-empty-r-package-up-to-the-best-standards.md).*
...
See the [corresponding summary](../summaries/source_AFuVF0oWFMY_creating-an-empty-r-package-up-to-the-best-standards.md).

## See also

- [Corresponding summary](../summaries/source_AFuVF0oWFMY_creating-an-empty-r-package-up-to-the-best-standards.md) — provisional synthesis for this video (`video_id` pair)
