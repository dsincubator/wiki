...
*See also the [corresponding summary](../summaries/source_wJnI0F_A-bU_creating-reproducible-examples.md).*
...
See the [corresponding summary](../summaries/source_wJnI0F_A-bU_creating-reproducible-examples.md).

## See also

- [Corresponding summary](../summaries/source_wJnI0F_A-bU_creating-reproducible-examples.md) — provisional synthesis for this video (`video_id` pair)
