...
*See also the [corresponding summary](../summaries/source_TEUbVjhooIg_project-oriented-workflow.md).*
...
See the [corresponding summary](../summaries/source_TEUbVjhooIg_project-oriented-workflow.md).

## See also

- [Corresponding summary](../summaries/source_TEUbVjhooIg_project-oriented-workflow.md) — provisional synthesis for this video (`video_id` pair)
