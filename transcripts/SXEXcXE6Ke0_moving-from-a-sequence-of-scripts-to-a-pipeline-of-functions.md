...
*See also the [corresponding summary](../summaries/source_SXEXcXE6Ke0_moving-from-a-sequence-of-scripts-to-a-pipeline-of-functions.md).*
...
See the [corresponding summary](../summaries/source_SXEXcXE6Ke0_moving-from-a-sequence-of-scripts-to-a-pipeline-of-functions.md).

## See also

- [Corresponding summary](../summaries/source_SXEXcXE6Ke0_moving-from-a-sequence-of-scripts-to-a-pipeline-of-functions.md) — provisional synthesis for this video (`video_id` pair)
