...
*See also the [corresponding summary](../summaries/source_uk-I5WrZsAc_shiny-wrap-up-and-demo.md).*
...
See the [corresponding summary](../summaries/source_uk-I5WrZsAc_shiny-wrap-up-and-demo.md).

## See also

- [Corresponding summary](../summaries/source_uk-I5WrZsAc_shiny-wrap-up-and-demo.md) — provisional synthesis for this video (`video_id` pair)
