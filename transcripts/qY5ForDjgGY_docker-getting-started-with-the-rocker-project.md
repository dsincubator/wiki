...
*See also the [corresponding summary](../summaries/source_qY5ForDjgGY_docker-getting-started-with-the-rocker-project.md).*
...
See the [corresponding summary](../summaries/source_qY5ForDjgGY_docker-getting-started-with-the-rocker-project.md).

## See also

- [Corresponding summary](../summaries/source_qY5ForDjgGY_docker-getting-started-with-the-rocker-project.md) — provisional synthesis for this video (`video_id` pair)
