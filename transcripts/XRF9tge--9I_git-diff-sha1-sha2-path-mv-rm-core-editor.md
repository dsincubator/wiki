...
*See also the [corresponding summary](../summaries/source_XRF9tge--9I_git-diff-sha1-sha2-path-mv-rm-core-editor.md).*
...
See the [corresponding summary](../summaries/source_XRF9tge--9I_git-diff-sha1-sha2-path-mv-rm-core-editor.md).

## See also

- [Corresponding summary](../summaries/source_XRF9tge--9I_git-diff-sha1-sha2-path-mv-rm-core-editor.md) — provisional synthesis for this video (`video_id` pair)
