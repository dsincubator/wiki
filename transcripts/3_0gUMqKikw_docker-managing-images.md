...
*See also the [corresponding summary](../summaries/source_3_0gUMqKikw_docker-managing-images.md).*
...
See the [corresponding summary](../summaries/source_3_0gUMqKikw_docker-managing-images.md).

## See also

- [Corresponding summary](../summaries/source_3_0gUMqKikw_docker-managing-images.md) — provisional synthesis for this video (`video_id` pair)
