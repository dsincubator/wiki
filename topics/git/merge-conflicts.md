...
Coverage is bilingual and workflow-integrated: English deep-dive [source_5gmTK8Cb-WE](../../summaries/source_5gmTK8Cb-WE_merge-conflicts.md), best-practice examples [source_eeUZ8dHsmG8](../../summaries/source_eeUZ8dHsmG8_git-practices-by-example.md), and Spanish interdependent-PR guidance [source_hs_Pzxny7XE](../../summaries/source_hs_Pzxny7XE_evita-solicitudes-de-fusion-interdependientes.md) plus `usethis` sync demos in English [source_fnfeYPPG9gM](../../summaries/source_fnfeYPPG9gM_usethis-pr-sync-english.md) and Spanish [source_xx5WNZgQEdY](../../summaries/source_xx5WNZgQEdY_usethis-pr-synch-espanol.md).
...
- **Conflict anatomy**: `<<<<<<< HEAD` / `=======` / `>>>>>>> branch` markers; Git cannot choose a winner when the same hunk diverges — [source_5gmTK8Cb-WE](../../summaries/source_5gmTK8Cb-WE_merge-conflicts.md).
- **Manual resolution**: edit file to desired outcome, `git add <file>` stages resolution, `git commit` completes merge; `git status` tracks conflict state; `git diff` shows remaining hunks — [source_5gmTK8Cb-WE](../../summaries/source_5gmTK8Cb-WE_merge-conflicts.md).
- **Tool-assisted**: `git mergetool`, RStudio merge tool, `usethis::pr_sync()` to sync PR branches — [source_fnfeYPPG9gM](../../summaries/source_fnfeYPPG9gM_usethis-pr-sync-english.md) and [source_xx5WNZgQEdY](../../summaries/source_xx5WNZgQEdY_usethis-pr-synch-espanol.md).
- **Prevention**: small focused PRs, frequent `git fetch` + `git merge main` or `git rebase main`, modular file decomposition (~200-line modules), early communication — [source_hs_Pzxny7XE](../../summaries/source_hs_Pzxny7XE_evita-solicitudes-de-fusion-interdependientes.md).
